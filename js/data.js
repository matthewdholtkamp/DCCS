...
const FRAMEWORK = {
  ...
  phases: [
    { id: 1, name: "Build", dateRange: "Now – 1 Mar 2026", mainEffort: "MSCoE Integration", hq: "TOMS, CTMC, BH, ER", status: "complete",
  ...
  serviceLines: [
    {
      ...
      tasks: [
        { id: "pcsl-p1-1", title: "Optimize Critical Services — Primary Care Access", description: "Establish baseline access metrics and address primary care appointment availability.", loe: 1, phase: 1, status: "complete", kpis: ["Routine wait times baseline established", "Nursing encounter volume tracked"] },
    ...
    },
    {
      ...
      tasks: [
        { id: "surg-p1-1", title: "Designate No-Fail Mission: Hospital Services / OB-GYN", description: "Establish OB/GYN and hospital inpatient services as no-fail critical missions.", loe: 1, phase: 1, status: "not-reviewed", kpis: ["No-fail designation established", "Coverage MOA signed"] },
        { id: "surg-p2-1", title: "Improve Throughput in New Facility", description: "Leverage new hospital to optimize OR scheduling, target 176 cases/month.", loe: 1, phase: 2, status: "not-reviewed", kpis: ["≥176 cases monthly", "First-case on-time starts improving"] },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "mh-p1-2", title: "BH Providers at Brigade Level (TOMS)", description: "Ensure each of the three training brigades has an embedded BH officer.", loe: 3, phase: 1, status: "not-reviewed", kpis: ["3/3 BDE BHOs assigned"] },
        ...
        { id: "mh-p2-2", title: "Asynchronous Screening Embedded in Intake", description: "PHQ-9 and PCL-5 completed before appointment and routed by nursing staff.", loe: 2, phase: 2, status: "not-reviewed", kpis: ["≥80% screening completion pre-visit"] },
    ...
    },
    {
      ...
      tasks: [
        { id: "ed-p1-1", title: "Optimize ER Flow — Screening & Redirection", description: "Screen and redirect non-emergent SITs. Expanded base-wide with Brigade Surgeon support.", loe: 1, phase: 1, status: "not-reviewed", kpis: ["16.8% decrease in trainees in ED", "24.1% redirection success", "Low acuity cases dropped from 45% to 34%"] },
        ...
        { id: "ed-p2-1", title: "ER Fast Track — Medic Led", description: "Implement medic-led fast track in new facility to handle low-acuity patients.", loe: 1, phase: 2, status: "not-reviewed", kpis: ["Fast track operational", "LOS reduced for low-acuity patients"] },
    ...
    },
    {
      ...
      tasks: [
        { id: "msc-p1-1", title: "Implement Trainee Care Model (TOMS/CTMC/ER)", description: "Execute three-pronged approach: right care, right place, right time for trainees.", loe: 3, phase: 1, status: "not-reviewed", kpis: ["Trainee care model operational", "BAS→CTMC→Hospital flow established"] },
        ...
        { id: "msc-p2-3", title: "Develop Automated Readiness Tracker", description: "Data pipeline from Army Vantage to Power BI dashboard for real-time readiness metrics.", loe: 3, phase: 2, status: "not-reviewed", kpis: ["≥90% units reporting in dashboard"] },
  ...
  crossCuttingTasks: [
    ...
    { id: "cc-p1-3", title: "Establish Accountability — Credentials & Safety", phase: 1, loe: 2, status: "in-progress", description: "Credentials Team KPIs: FPPE closure within 6 months, OPPE on-time closures. 100% BLS compliance, timely medical record closure (72hr outpatient / 30-day inpatient).", kpis: ["Credentials team KPI: FPPE closure within six months", "OPPE on time closures", "100% BLS compliance", "Record closure compliance tracked"] },
    { id: "cc-p2-1", title: "Man to Functional Needs Analysis", phase: 2, loe: 2, status: "in-progress", description: "Unified manning document published. TDA and manning for military/civilians published. Current challenge: too many providers, not enough nurses/medics — manning is inverse to care ladder needs.", kpis: ["Unified manning document is published", "TDA and manning for military/civilians published", "Hiring medic lower level people (not just providers)"] },
